...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TolerationSettings) DeepCopyInto(out *TolerationSettings) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TolerationSettings.
func (in *TolerationSettings) DeepCopy() *TolerationSettings {
	if in == nil {
		return nil
	}
	out := new(TolerationSettings)
	in.DeepCopyInto(out)
	return out
}
