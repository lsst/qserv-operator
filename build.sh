...
# Hack, file below is automatically generated by kubebuilder and not compliant with goimport requirements
goimports -w api/v1beta1/zz_generated.deepcopy.go
