...
# used to store emptychunk files generated by replication controller
# TODO: replication controller should push this file to czar
# FIXME: remove this line once line above is implemented
